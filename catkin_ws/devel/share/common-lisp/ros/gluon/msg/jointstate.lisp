...
(cl:defmethod cl:initialize-instance :after ((m <jointstate>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'jointstate)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gluon-msg:<jointstate> is deprecated: use gluon-msg:jointstate instead.")))

(cl:ensure-generic-function 'jointstate1-val :lambda-list '(m))
(cl:defmethod jointstate1-val ((m <jointstate>))
...
(cl:defmethod jointstate2-val ((m <jointstate>))
...
(cl:defmethod jointstate3-val ((m <jointstate>))
...
(cl:defmethod jointstate4-val ((m <jointstate>))
...
(cl:defmethod jointstate5-val ((m <jointstate>))
...
(cl:defmethod jointstate6-val ((m <jointstate>))
