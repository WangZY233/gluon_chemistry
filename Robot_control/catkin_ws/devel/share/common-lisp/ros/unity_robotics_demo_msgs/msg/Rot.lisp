...
(cl:defmethod cl:initialize-instance :after ((m <Rot>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Rot)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name unity_robotics_demo_msgs-msg:<Rot> is deprecated: use unity_robotics_demo_msgs-msg:Rot instead.")))

(cl:ensure-generic-function 'jointstate1-val :lambda-list '(m))
(cl:defmethod jointstate1-val ((m <Rot>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader unity_robotics_demo_msgs-msg:jointstate1-val is deprecated.  Use unity_robotics_demo_msgs-msg:jointstate1 instead.")
  (jointstate1 m))

(cl:ensure-generic-function 'jointstate2-val :lambda-list '(m))
(cl:defmethod jointstate2-val ((m <Rot>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader unity_robotics_demo_msgs-msg:jointstate2-val is deprecated.  Use unity_robotics_demo_msgs-msg:jointstate2 instead.")
  (jointstate2 m))

(cl:ensure-generic-function 'jointstate3-val :lambda-list '(m))
(cl:defmethod jointstate3-val ((m <Rot>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader unity_robotics_demo_msgs-msg:jointstate3-val is deprecated.  Use unity_robotics_demo_msgs-msg:jointstate3 instead.")
  (jointstate3 m))

(cl:ensure-generic-function 'jointstate4-val :lambda-list '(m))
(cl:defmethod jointstate4-val ((m <Rot>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader unity_robotics_demo_msgs-msg:jointstate4-val is deprecated.  Use unity_robotics_demo_msgs-msg:jointstate4 instead.")
  (jointstate4 m))

(cl:ensure-generic-function 'jointstate5-val :lambda-list '(m))
(cl:defmethod jointstate5-val ((m <Rot>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader unity_robotics_demo_msgs-msg:jointstate5-val is deprecated.  Use unity_robotics_demo_msgs-msg:jointstate5 instead.")
  (jointstate5 m))

(cl:ensure-generic-function 'jointstate6-val :lambda-list '(m))
(cl:defmethod jointstate6-val ((m <Rot>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader unity_robotics_demo_msgs-msg:jointstate6-val is deprecated.  Use unity_robotics_demo_msgs-msg:jointstate6 instead.")
  (jointstate6 m))
